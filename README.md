...
- `~/.local/share/applications/APRS-Messenger.desktop`
- Icons under `~/.local/share/icons/hicolor/*/apps/aprs-messenger.png`
- Local copies: `APRS-Messenger.desktop` in the app folder
